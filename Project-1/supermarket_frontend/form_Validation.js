...
function validateDesc() {
    ...
    if (!exp.test(description)) {
        document.getElementById("descError").innerText = "Description should have atleast 15 characters";
        return false;
    }
...
function validateType() {
    ...
    let flag;
    if (type == "") {
        document.getElementById("typeError").innerText = "Type should not empty";
        return false;
    }
    if (!exp.test(type)) {
