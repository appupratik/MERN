...
fetch("http://localhost:3000/product?id=" + id)
    ...
    .then((product) => {
        ...
        let width = Math.round((averageRating / 5) * 100);
        ...
        <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item" id="rating" style="height:50px">
                <div id="productRating" style="width:112px; position:absolute">
                    ...
                    <div class="dummystars" style="width:${width}%; position:absolute; white-space:nowrap; overflow:hidden;">${ratingString}</div>
                </div>
...
function submitRating(id) {
    ...
    fetch("http://localhost:3000/updateRating?id=" + id, {
        ...
        .then((product) => {
            ...
            let averageRating = Number(product.rating) / Number(product.rating_count);
